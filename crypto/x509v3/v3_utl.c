                                           ...
                                           GENERAL_NAMES *gens)
{
    ...
    /* First supplied X509_NAME ; TODO(1.2.0): Constify X509_NAME input arg */
    while ((i = X509_NAME_get_index_by_NID((X509_NAME *) name,
                         ...
                         unsigned int flags, int check_type, char **peername)
{
    ...
    while ((i = X509_NAME_get_index_by_NID((X509_NAME *) name, cnid, i)) >= 0) {
