...
=head1 SYNOPSIS
 ...
 void CRYPTO_free_ex_data(int class_index, void *parent, CRYPTO_EX_DATA *r);
...
The B<class_index> identifies the structure type, the B<parent> is
be the pointer to the actual structure, and B<r> is a pointer to this
